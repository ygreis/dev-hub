    ...
    <Suspense fallback={<RouteFallback />}>
      <Routes>
        <Route element={<LandingTemplate />}>
          ...
          <Route path="quem-sou" element={<Navigate to="/about" replace />} />
        </Route>

        <Route path="lib/:slug" element={<LibraryTemplate />}>
          <Route index element={<LibraryHomePage />} />
          <Route path="docs" element={<LibraryDocsPage />} />
          <Route path="docs/:groupSlug/:pageSlug" element={<LibraryDocsPage />} />
          <Route path="examples" element={<Navigate to="../docs" replace />} />
